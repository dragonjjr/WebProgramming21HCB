...
namespace Common
{
    ...
    {
        public static string url_Partner = "https://api.rokia.top/";
        public static string conn = string.Empty;
        public static string SecretKey = "Nhom1IBanking";
        public static string SecretKey_Partner = "nhom12ibFTP";
        public static string Signature = "nhom12FTBRokia";
        ...
        public static string RSA_Key_Partner = "<RSAKeyValue><Modulus>vDAmhpe7/2KUCGzqBWQqUN+KNgbJ4cKrkbkC+pJ/wixshiKTmJNLmtcd3DB4EVEhlC80hrUc0UE9FtMD+k1kiDjc57qeQJ1x93j+89mZVrOzxm1koxUl9VjHtmp4m3IalRr41g9UDS226sYYL/Mxxn5Xh+5hEyaHlgV74oLI4Nk=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
        ...
        public static string GetTokenOfPartner(string input)
        {
        ...
        public static string EncryptionPartner(string strText)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider(1024))
            {
                try
                {
                    rsa.FromXmlString(RSA_Key_Partner);
